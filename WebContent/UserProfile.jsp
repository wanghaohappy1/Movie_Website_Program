								...
								<table style="float: left;">
									<tr>
										<td><img style="clear: both; text-align: center;"
											height="100" src="<%=movie.getPosterImage()%>" /></td>
									</tr>
									<tr>
									...
									<tr>
										<td><p><%=movie.getId()%></p></td>
									</tr>
									<tr>
										<td><p><%=review.getReviews()%></p></td>
									</tr>
									<tr>
										<td><button name="action" value="detail">see
												movie detail</button></td>
									</tr>
								</table>
							</form>
