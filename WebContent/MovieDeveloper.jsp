				...
				<ul id="sliderContent">
					<li class="sliderImage"><a
						href="MovieDetail.jsp?id=1&username=<%=request.getParameter("username")%>"><img
							src="http://verysmartbrothas.com/images/Non-Stop-2014-movie-Wallpaper-1280x800.jpg?c07647"
					...
					<li class="sliderImage"><a
						href="MovieDetail.jsp?id=3&username=<%=request.getParameter("username")%>"><img
							src="Image/sirendingzhi.jpg" width=900 height=300 /></a> <span
						class="top"><strong><a
								...
								<table>
									<tr>
										<td style="text-align: center;"><img
											style="clear: both; text-align: center;" height="100"
									...
									<tr>
										<td style="text-align: center;"><button name="action"
												value="change">ChangeMyMovie</button></td>
										<td><input name="newIdd"
											style="height: 16px; width: 16px; top: 16px; left: 16px;"
											name="a" value="<%=movie.getId()%>" /></td>
									</tr>
								</table>
							</form>
